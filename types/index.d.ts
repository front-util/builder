import type { Configuration, RuleSetRule, Plugin, GeneratorOptionsByModuleType, ModuleFederationPluginOptions, DevServer, OptimizationSplitChunksOptions, SharedConfig } from '@rspack/core';
